            ...
            <div class="container">
                ...
                <section class="main__novelty novelty">
                    <div class="novelty__content">
                        ...
                        if (ceil($total_count / $per_page) == floor($total_count / $per_page) && $page == $total_pages) {
                            echo "Статей немає";
                        }
                        ?>
                            ...
                            ?>
                                <div class="novelty__element element-novelty">
                                    ...
                                    <div class="element-novelty__content">
                                        <a class="element-novelty__title" style="cursor:pointer" href="article.php?id=<?php echo $article['id'] ?>">
                                            <?= $article['title'] ?>
                                        </a>
                                        <?php
                                        $art_cat = false;
                        ...
                        <div class="paginator__flex">
                            ...
                            if (ceil($total_count / $per_page) != floor($total_count / $per_page) || $page != $total_pages) {
                                ...
                                if ($page > 1) {
                            ?>
                                    <a class="paginator__left" href="articles.php?page=<?= $page - 1 ?>">Минула сторінка</a>
                                <?php
                                }
                                if ($page < $total_pages) {
                                ?>
                                    <a class="paginator__right" href="articles.php?page=<?= $page + 1 ?>">Наступна сторінка</a>
                            <?php
                                }
                                echo '</div>';
                            }
